...
h_bkg1 = ROOT.TH1F("h_bkg1","Background",100,0,100)
h_bkg2 = ROOT.TH1F("h_bkg2","Background",100,0,100)
h_data = ROOT.TH1F("h_data","Data",100,0,100)
...
ppm.plotDataMC(h_bkg_vec,bkg_names,h_data, doPause=True, isLog=False, title="Test plot",
               subtitles=subtitles, subLegText=subLegText, scaleMCtoData=True, markerSize=0.8,
               lumi=3.64, lumiUnit="ab", energy=14, saveAs="test.pdf")
